...
public class FlowExecutionStatsByCollectorImpl implements FlowExecutionStatsDefinition {
     ...
     */
    public FlowExecutionStatsByCollectorImpl(FlowExecutionsCollector flowExecutionsCollector){
        ...
        if(numOfExecutions > 0) {
            ...
            stepExecuteDataList.stream()
                    ...
                    .forEach(stepExecuteData -> stepExecutionStatisticsList.add(
                            new StepExecutionStatsByCollectorImpl(stepExecuteData.getFinalName(), flowExecutionsCollector)));
            Long totalTime = 0L;
